                ...
                <td className="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                  <div className="flex items-center justify-center space-x-2">
                    <button
                      ...
                      className="text-green-600 hover:text-green-900 transition-colors px-2 py-1 text-sm"
                      title="Ver detalles"
                    >
                      Ver
                    </button>
                    ...
                    <button
                      ...
                      className="text-purple-600 hover:text-purple-900 transition-colors px-2 py-1 text-sm"
